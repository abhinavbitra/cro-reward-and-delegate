...
CHAINID=crossfire
COUNT=50000 #Number of transactions till check of last transaction
SLEEP=500s #length of the sleep before the scrip tries to check if the last transaction was broadcasted (0 = disabled)
