...
do
    ...
    echo qwertyabcd | ./chain-maind tx staking delegate crocncl1k7yvmaffyp8nnp7xepcx0rashu8rv3yuk30923 "0.01*currentAvailableReward"tcro --from cross-fire-testing --chain-id "crossfire" --gas-prices="0.1basetcro" -y > /dev/null 2>&1
    sleepTime=$((1*60))
